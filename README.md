...
cd application
# Run application that links to library V1 and the vtable for the Shape class is from library V1.
...
# This leads to undefined behavior due to ABI change and incorrect/inappropriate overridden function is called via the library incompatible vtable.
LD_LIBRARY_PATH=../library_v2 ./app.app

# Run application that links to library V2 and the vtable for the Shape class is from library V2.
